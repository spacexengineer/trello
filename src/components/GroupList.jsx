  ...
  render() {
    const groupElement = this.state.data.map(group => (
      <Group
        ...
        onChangeGroup={({ target }) =>
          this.setState({ currentTitleGroup: target.value })
        }
        ...
        onChangeTaskDescription={({ target }) =>
          this.setState({ currentDescriptionTask: target.value })
        }
      />
    ));
          ...
          <div className="groups__item">
            <div className="inner">
              {this.state.isAddGroup ? (
                ...
                <div onClick={this.handleClickAddGroup}>+ Add another list</div>
              )}
            </div>
          </div>
        </div>
